...
plt.grid(True)
plt.legend()
plt.savefig('valscore_random1616_k=5.png', bbox_inches='tight')
plt.show()
...
plt.grid(True)
plt.legend()
#plt.savefig('Baseline Accuracy Score_random1616.png', bbox_inches='tight')
plt.show()
...
plt.grid()
plt.legend()
#plt.savefig('1616AL Learning Accuracy Score__Badge_100_1616.png', bbox_inches='tight')
plt.show()
...
ax.legend()
plt.savefig("1616_k=5constrained_clusters_c5.png", bbox_inches="tight")
plt.show()
...
ax.legend()
plt.savefig("1616_k=5constrained_clusters_c3.png", bbox_inches="tight")
plt.show()
...
ax.legend()
plt.savefig("1616_k=5constrained_clusters_c7.png", bbox_inches="tight")
plt.show()
...
plt.grid()
plt.legend()
plt.savefig('ALL_100_1616_k=5.png', bbox_inches='tight')
plt.show()
...
with open("label_acc_1616_k=5.txt", "a") as file:
    file.write("Baseline_1616_k=5: " + str(label_accuracies_baseline) + "\n")
    file.write("Badge_1616_k=5: " + str(label_accuracies_badge) + "\n")
    file.write("TC7_1616_k=5: " + str(label_accuracies_tc_7) + "\n")
    file.write("TC5_1616_k=5: " + str(label_accuracies_tc_5) + "\n")
    file.write("TC3_1616_k=5: " + str(label_accuracies_tc_3) + "\n")

    file.write("FULL_BL_1616_k=5: " + str(accuracy_full) + "\n")
    file.write("FULL_BADGE_1616_k=5: " + str(acc_badge) + "\n")
    file.write("FULL_TC7_1616_k=5: " + str(acc_tc7) + "\n")
    file.write("FULL_TC5_1616_k=5: " + str(acc_tc5) + "\n")
    file.write("FULL_TC3_1616_k=5: " + str(acc_tc3) + "\n")
