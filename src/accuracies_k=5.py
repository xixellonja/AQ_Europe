...
baseline_42_k5 = np.array([0,   0 ,0.73, 0.8, 0.63, 0])
badge_42_k5    = np.array([0,   0,  0.68, 0.84, 0.64 ,0])
full_bl_42_k5  = 0.6956521739130435
full_badge_42_k5 = 0.717391304347826

baseline_123_k5 = np.array([0,   0.67, 0.76, 0.42, 0, 0])
badge_123_k5    = np.array([0,   0,  0.75, 0.85, 0.6 , 0 ])
full_bl_123_k5  = 0.6149068322981367
full_badge_123_k5 = 0.7267080745341615

baseline_1616_k5 = np.array([0,   0, 0.82 ,0.73,  0.6, 0])
badge_1616_k5    = np.array([0,  0,  0.75, 0.81, 0.59, 0 ])
full_bl_1616_k5  = 0.6770186335403726
full_badge_1616_k5 = 0.703416149068323



full_baseline_values = [full_bl_42_k5, full_bl_123_k5, full_bl_999, full_bl_1616_k5]
full_AL_values = [full_badge_42_k5, full_badge_123_k5, full_badge_999, full_badge_1616_k5]
...
baseline_data = [baseline_42_k5, baseline_123_k5, baseline_999, baseline_1616_k5]
badge_data    = [badge_42_k5, badge_123_k5, badge_999, badge_1616_k5]
...
for i in range(len(baseline_42_k5)):
